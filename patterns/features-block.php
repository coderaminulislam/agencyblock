 ...
 * Slug: agency-block/features-block
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"5px"}}},"fontSize":"sm-r"} -->
<p class="has-sm-r-font-size" style="margin-top:5px">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
